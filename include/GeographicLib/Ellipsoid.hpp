...
namespace GeographicLib {
  ...
  public:
     ...
     **********************************************************************/
    real PolarRadius() const { return b_; }
     ...
     **********************************************************************/
    real Volume() const
    { return (4 * Math::pi()) * Math::sq(a_) * b_ / 3; }
    ///@}
     ...
     **********************************************************************/
    real SecondFlattening() const { return f_ / (1 - f_); }
     ...
     *   oblate ellipsoid, or prolate ellipsoid.
     **********************************************************************/
    real ThirdFlattening() const { return n_; }
     ...
     *   oblate ellipsoid, or prolate ellipsoid.
     **********************************************************************/
    real EccentricitySq() const { return e2_; }
     ...
     **********************************************************************/
    real SecondEccentricitySq() const { return e12_; }
     ...
     *   ellipsoid.
     **********************************************************************/
    real ThirdEccentricitySq() const { return e2_ / (2 - e2_); }
    ///@}
     ...
     **********************************************************************/
    real ParametricLatitude(real phi) const;
     ...
     **********************************************************************/
    real InverseParametricLatitude(real beta) const;
     ...
     **********************************************************************/
    real GeocentricLatitude(real phi) const;
     ...
     * &phi; lies in [&minus;90&deg;, 90&deg;].
     **********************************************************************/
    real InverseGeocentricLatitude(real theta) const;
     ...
     **********************************************************************/
    real RectifyingLatitude(real phi) const;
     ...
     * &phi; lies in [&minus;90&deg;, 90&deg;].
     **********************************************************************/
    real InverseRectifyingLatitude(real mu) const;
     ...
     **********************************************************************/
    real AuthalicLatitude(real phi) const;
     ...
     * &phi; lies in [&minus;90&deg;, 90&deg;].
     **********************************************************************/
    real InverseAuthalicLatitude(real xi) const;
     ...
     **********************************************************************/
    real ConformalLatitude(real phi) const;
     ...
     * &phi; lies in [&minus;90&deg;, 90&deg;].
     **********************************************************************/
    real InverseConformalLatitude(real chi) const;
     ...
     **********************************************************************/
    real IsometricLatitude(real phi) const;
     ...
     **********************************************************************/
    real InverseIsometricLatitude(real psi) const;
    ///@}
     ...
     **********************************************************************/
    real CircleRadius(real phi) const;
     ...
     * result is undefined if this condition does not hold.
     **********************************************************************/
    real CircleHeight(real phi) const;
     ...
     * result is undefined if this condition does not hold.
     **********************************************************************/
    real MeridianDistance(real phi) const;
     ...
     * result is undefined if this condition does not hold.
     **********************************************************************/
    real MeridionalCurvatureRadius(real phi) const;
     ...
     * result is undefined if this condition does not hold.
     **********************************************************************/
    real TransverseCurvatureRadius(real phi) const;
     ...
     **********************************************************************/
    real NormalCurvatureRadius(real phi, real azi) const;
    ///@}
     ...
     **********************************************************************/
    static real SecondFlatteningToFlattening(real fp)
    { return fp / (1 + fp); }
     ...
     **********************************************************************/
    static real FlatteningToSecondFlattening(real f)
    { return f / (1 - f); }
     ...
     * The returned value \e f lies in (&minus;&infin;, 1).
     **********************************************************************/
    static real ThirdFlatteningToFlattening(real n)
    { return 2 * n / (1 + n); }
     ...
     **********************************************************************/
    static real FlatteningToThirdFlattening(real f)
    { return f / (2 - f); }
     ...
     * The returned value \e f lies in (&minus;&infin;, 1).
     **********************************************************************/
    static real EccentricitySqToFlattening(real e2)
     ...
     **********************************************************************/
    static real FlatteningToEccentricitySq(real f)
    { return f * (2 - f); }
     ...
     * The returned value \e f lies in (&minus;&infin;, 1).
     **********************************************************************/
    static real SecondEccentricitySqToFlattening(real ep2)
     ...
     **********************************************************************/
    static real FlatteningToSecondEccentricitySq(real f)
     ...
     * The returned value \e f lies in (&minus;&infin;, 1).
     **********************************************************************/
    static real ThirdEccentricitySqToFlattening(real epp2) {
      using std::sqrt;
     ...
     **********************************************************************/
    static real FlatteningToThirdEccentricitySq(real f)
